...
const lifecycle = [
  ...
  ["Assign", "Assigned", "Requires Lifecycle Published or Assigned; not Draft. Teacher quizzes: Approval=Approved. school-type: Published + Approved; assign to linked children. ≥1 question."],
...
const permissions = [
  ...
  ["List / view Published quizzes (manage catalog)", "All school-type (any school/creator)", "All school-type (any school/creator)", "All school-type (any school/creator)", "All school-type (any school/creator)", "All school-type (any school/creator)", "All school-type (any school/creator) + linked assignments + own school-type", "Assigned ∪ student Public audience"],
