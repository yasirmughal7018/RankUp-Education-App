...
Pending Approval ── not assignable; owner may edit until school/portal approval
  ...
  ${htmlList([
    ...
    "/quizzes/:id — manage: add Q / publish / delete (Draft); Request edit after approval/publish; assign / duplicate / cancel / retry / monitor (Published/Assigned). Archive and unarchive of Published or Assigned: PortalAdmin only.",
    "/quizzes/:id/monitoring — progress board for in-scope students.",
    "/quizzes/assignments — cross-quiz assignment board (role-scoped students/children; Teacher/Coordinator roster filter; Parent linked-child filter).",
