/**
 * PortalAdmin queue of pending requests to edit Active questions.
 */
...
export function QuestionEditRequestsPage() {
  ...
  const { data: items = [], isLoading, error } = usePendingQuestionEditRequestsQuery({
  ...
  if (!isPortalAdmin) {
    return (
      <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6">
        <PageHeader
          title="Edit requests"
          description="Only Portal Admin can review requests to edit Active questions."
          backTo="/questions"
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6">
      <PageHeader
        title="Question edit requests"
        description="Approve a one-time edit of an Active question, or reject with a reason."
        backTo="/questions"
        backAriaLabel="Back to question bank"
      />
