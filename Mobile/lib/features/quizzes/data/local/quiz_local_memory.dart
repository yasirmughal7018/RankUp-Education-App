...
final localQuizRows = <LocalQuizRow>[
  ...
  LocalQuizRow(
    ...
    schoolId: 'school-abc',
    campusId: 'campus-main',
    quizTitle: 'Equivalent Fractions Sprint',
    description: 'Quick practice on identifying and simplifying fractions.',
    quizTypeId: 1,
    className: 'Grade 5',
    subject: 'Mathematics',
    ...
    timeLimitMinutes: 12,
    numberOfAttempts: 2,
    startDateTime: _now.subtract(const Duration(hours: 3)),
    endDateTime: _now.add(const Duration(hours: 8)),
    shuffleQuestions: false,
    shuffleOptions: true,
    instructions: const ['Complete the short practice before evening.'],
    isActive: true,
    createdBy: 'Math Teacher',
    approvedBy: 'Academic Coordinator',
    approvalStatusId: 24,
    createdDate: _now.subtract(const Duration(days: 1)),
    modifiedDate: _now,
  ),
  LocalQuizRow(
    id: 'quiz-7',
    schoolId: 'school-abc',
    campusId: 'campus-main',
    quizTitle: 'Grammar Revision Today',
    description: 'Daily English grammar check for sentence tense accuracy.',
    quizTypeId: 2,
    className: 'Grade 5',
    subject: 'English',
    ...
    timeLimitMinutes: 15,
    numberOfAttempts: 1,
    startDateTime: _now.subtract(const Duration(hours: 1)),
    endDateTime: _now.add(const Duration(hours: 10)),
    shuffleQuestions: false,
    shuffleOptions: false,
    instructions: const ['Use complete sentences for written answers.'],
    isActive: true,
  ...
  LocalQuizRow(
    ...
    schoolId: 'school-abc',
    campusId: 'campus-main',
    quizTitle: 'Computer Basics Check',
    description: 'Yesterday quiz about common computer parts and safe use.',
    quizTypeId: 1,
    className: 'Grade 5',
    subject: 'Computer',
    ...
    timeLimitMinutes: 10,
    numberOfAttempts: 2,
    startDateTime: _now.subtract(const Duration(days: 1, hours: 2)),
    endDateTime: _now.subtract(const Duration(days: 1)),
    shuffleQuestions: false,
    shuffleOptions: false,
    instructions: const ['Review basic computer terms before attempting.'],
    isActive: true,
    createdBy: 'Computer Teacher',
    approvedBy: 'Academic Coordinator',
    approvalStatusId: 24,
    createdDate: _now.subtract(const Duration(days: 3)),
    modifiedDate: _now.subtract(const Duration(days: 1)),
  ...
  LocalQuizRow(
    ...
    schoolId: 'school-abc',
    campusId: 'campus-main',
    quizTitle: 'Digestive System Review',
    description: 'Yesterday science review for the digestive system lesson.',
    quizTypeId: 2,
    className: 'Grade 5',
    subject: 'Science',
    topic: 'Human Digestive System',
    ...
    timeLimitMinutes: 18,
    numberOfAttempts: 1,
    startDateTime: _now.subtract(const Duration(days: 1, hours: 5)),
    endDateTime: _now.subtract(const Duration(days: 1, hours: 1)),
    shuffleQuestions: true,
    shuffleOptions: true,
    instructions: const ['Expired quizzes are visible for record only.'],
    isActive: true,
    createdBy: 'Science Teacher',
    approvedBy: 'Academic Coordinator',
    approvalStatusId: 24,
  ...
  LocalQuizRow(
    ...
    schoolId: 'school-abc',
    campusId: 'campus-main',
    quizTitle: 'Word Problems Weekly Drill',
    description: 'Last 7 days mathematics drill for fraction word problems.',
    quizTypeId: 1,
    className: 'Grade 5',
    subject: 'Mathematics',
    ...
    timeLimitMinutes: 20,
    numberOfAttempts: 2,
    startDateTime: _now.subtract(const Duration(days: 3)),
    endDateTime: _now.subtract(const Duration(days: 2)),
    shuffleQuestions: false,
    shuffleOptions: true,
    instructions: const ['Show working for descriptive answers.'],
    isActive: true,
    createdBy: 'Math Teacher',
    approvedBy: 'Academic Coordinator',
    approvalStatusId: 24,
    createdDate: _now.subtract(const Duration(days: 5)),
    modifiedDate: _now.subtract(const Duration(days: 2)),
  ),
  LocalQuizRow(
    id: 'quiz-11',
    schoolId: 'school-abc',
    campusId: 'campus-main',
    quizTitle: 'Photosynthesis Quick Test',
    description: 'Short science assessment from this week.',
    quizTypeId: 2,
    className: 'Grade 5',
    subject: 'Science',
    topic: 'Photosynthesis',
    ...
    timeLimitMinutes: 15,
    numberOfAttempts: 1,
    startDateTime: _now.subtract(const Duration(days: 5)),
    endDateTime: _now.subtract(const Duration(days: 4)),
    shuffleQuestions: false,
    shuffleOptions: false,
    instructions: const ['Review plant food-making process.'],
    isActive: true,
    createdBy: 'Science Teacher',
    approvedBy: 'Academic Coordinator',
    approvalStatusId: 24,
    createdDate: _now.subtract(const Duration(days: 7)),
    modifiedDate: _now.subtract(const Duration(days: 4)),
    resultStatus: 'Reviewed',
    resultPercent: 76,
  ),
  LocalQuizRow(
    ...
    schoolId: 'school-abc',
    campusId: 'campus-main',
    quizTitle: 'Vocabulary Surprise Round',
    description: 'Surprise English quiz from the last 7 days.',
    quizTypeId: 4,
    className: 'Grade 5',
    subject: 'English',
    topic: 'Vocabulary',
    ...
    timeLimitMinutes: 10,
    numberOfAttempts: 1,
    startDateTime: _now.subtract(const Duration(days: 6)),
    endDateTime: _now.subtract(const Duration(days: 6, hours: -2)),
    shuffleQuestions: true,
    shuffleOptions: false,
    instructions: const ['This surprise quiz is now closed.'],
    isActive: true,
    createdBy: 'English Teacher',
    approvedBy: 'Academic Coordinator',
    approvalStatusId: 24,
  ...
  LocalQuizRow(
    ...
    schoolId: 'school-abc',
    campusId: 'campus-main',
    quizTitle: 'Decimal Place Value',
    description: 'Last 15 days quiz for reading and comparing decimals.',
    quizTypeId: 1,
    className: 'Grade 5',
    subject: 'Mathematics',
    topic: 'Decimals',
    ...
    timeLimitMinutes: 15,
    numberOfAttempts: 2,
    startDateTime: _now.subtract(const Duration(days: 9)),
    endDateTime: _now.subtract(const Duration(days: 8)),
    shuffleQuestions: false,
    shuffleOptions: true,
    instructions: const ['Read decimal places carefully.'],
    isActive: true,
    createdBy: 'Math Teacher',
    approvedBy: 'Academic Coordinator',
    approvalStatusId: 24,
    ...
    modifiedDate: _now.subtract(const Duration(days: 8)),
    resultStatus: 'AI Review',
  ),
  LocalQuizRow(
    id: 'quiz-14',
    schoolId: 'school-abc',
    campusId: 'campus-main',
    quizTitle: 'Reading Comprehension Set A',
    description: 'Passage-based English quiz from the last 15 days.',
    quizTypeId: 2,
    className: 'Grade 5',
    subject: 'English',
    ...
    timeLimitMinutes: 20,
    numberOfAttempts: 1,
    startDateTime: _now.subtract(const Duration(days: 12)),
    endDateTime: _now.subtract(const Duration(days: 11)),
    shuffleQuestions: false,
    shuffleOptions: false,
    instructions: const ['Read the passage twice before answering.'],
    isActive: true,
    createdBy: 'English Teacher',
    approvedBy: 'Academic Coordinator',
    approvalStatusId: 24,
  ...
  LocalQuizRow(
    ...
    schoolId: 'school-abc',
    campusId: 'campus-main',
    quizTitle: 'Food Chains Practice',
    description: 'Science practice quiz from within the last 15 days.',
    quizTypeId: 1,
    className: 'Grade 5',
    subject: 'Science',
    topic: 'Food Chains',
    ...
    timeLimitMinutes: 12,
    numberOfAttempts: 2,
    startDateTime: _now.subtract(const Duration(days: 14)),
    endDateTime: _now.subtract(const Duration(days: 13)),
    shuffleQuestions: true,
    shuffleOptions: true,
    instructions: const ['Identify producers, consumers, and decomposers.'],
    isActive: true,
    createdBy: 'Science Teacher',
    approvedBy: 'Academic Coordinator',
    approvalStatusId: 24,
    createdDate: _now.subtract(const Duration(days: 16)),
    modifiedDate: _now.subtract(const Duration(days: 13)),
    resultStatus: 'Teacher Review',
  ),
  LocalQuizRow(
    id: 'quiz-16',
    schoolId: 'school-abc',
    campusId: 'campus-main',
    quizTitle: 'Computer Safety Assessment',
    description: 'Older completed assessment for online safety basics.',
    quizTypeId: 2,
    className: 'Grade 5',
    subject: 'Computer',
    topic: 'Online Safety',
    ...
    timeLimitMinutes: 15,
    numberOfAttempts: 1,
    startDateTime: _now.subtract(const Duration(days: 18)),
    endDateTime: _now.subtract(const Duration(days: 17)),
    shuffleQuestions: false,
    shuffleOptions: false,
    instructions: const ['Use safe internet behavior rules.'],
    isActive: true,
    createdBy: 'Computer Teacher',
    approvedBy: 'Academic Coordinator',
    approvalStatusId: 24,
    createdDate: _now.subtract(const Duration(days: 20)),
    modifiedDate: _now.subtract(const Duration(days: 17)),
    resultStatus: 'Reviewed',
    resultPercent: 91,
  ),
  LocalQuizRow(
    ...
    schoolId: 'school-abc',
    campusId: 'campus-main',
    quizTitle: 'Math Competition Qualifier',
    description: 'Upcoming competition quiz for top classroom performers.',
    quizTypeId: 3,
    className: 'Grade 5',
    subject: 'Mathematics',
    ...
    timeLimitMinutes: 25,
    numberOfAttempts: 1,
    startDateTime: _now.add(const Duration(days: 1, hours: 2)),
    endDateTime: _now.add(const Duration(days: 1, hours: 3)),
    shuffleQuestions: true,
    shuffleOptions: true,
    instructions: const ['Competition quiz opens at the scheduled time.'],
    isActive: true,
    createdBy: 'School Head',
    approvedBy: 'Principal',
    approvalStatusId: 25,
  ...
  LocalQuizRow(
    ...
    schoolId: 'school-abc',
    campusId: 'campus-main',
    quizTitle: 'Science Lab Safety',
    description: 'Upcoming science quiz about safe lab behavior.',
    quizTypeId: 2,
    className: 'Grade 5',
    subject: 'Science',
    topic: 'Lab Safety',
    ...
    timeLimitMinutes: 15,
    numberOfAttempts: 1,
    startDateTime: _now.add(const Duration(days: 4)),
    endDateTime: _now.add(const Duration(days: 5)),
    shuffleQuestions: false,
    shuffleOptions: true,
    instructions: const ['Prepare lab safety rules before the due date.'],
    isActive: true,
    createdBy: 'Science Teacher',
    approvedBy: 'Academic Coordinator',
    approvalStatusId: 25,
  ...
  LocalQuizRow(
    ...
    schoolId: 'school-abc',
    campusId: 'campus-main',
    quizTitle: 'English Speaking Practice',
    description: 'Upcoming practice quiz for short answer fluency.',
    quizTypeId: 1,
    className: 'Grade 5',
    subject: 'English',
    ...
    timeLimitMinutes: null,
    numberOfAttempts: 3,
    startDateTime: _now.add(const Duration(days: 7)),
    endDateTime: _now.add(const Duration(days: 9)),
    shuffleQuestions: false,
    shuffleOptions: false,
    instructions: const ['Write short clear answers in complete sentences.'],
    isActive: true,
    createdBy: 'English Teacher',
    approvedBy: 'Academic Coordinator',
    approvalStatusId: 25,
  ...
  LocalQuizRow(
    ...
    schoolId: 'school-abc',
    campusId: 'campus-main',
    quizTitle: 'Monthly Revision Mega Quiz',
    description: 'Upcoming mixed-subject quiz for monthly revision.',
    quizTypeId: 3,
    className: 'Grade 5',
    subject: 'General',
    topic: 'Monthly Revision',
    difficultyLevel: 'Hard',
    totalQuestions: 10,
    totalMarks: 20,
    timeLimitMinutes: 35,
    numberOfAttempts: 1,
    startDateTime: _now.add(const Duration(days: 12)),
    endDateTime: _now.add(const Duration(days: 13)),
    shuffleQuestions: true,
    shuffleOptions: true,
    instructions: const ['This mixed quiz includes math, science, and English.'],
    isActive: true,
...
final localQuestionRows = <LocalQuestionRow>[
  ...
  LocalQuestionRow(
    id: 'q-017',
    questionText: 'A keyboard is used to type text into a computer.',
    questionTypeId: 42,
    className: 'Grade 5',
    subject: 'Computer',
    topic: 'Computer Basics',
    ...
    hint: 'Think about input devices.',
    estimatedTimeSeconds: 30,
    marks: 1,
    isActive: true,
    statusId: 62,
  ...
  LocalQuestionRow(
    id: 'q-018',
    questionText: 'Which part of a plant usually absorbs water from soil?',
    questionTypeId: 40,
    className: 'Grade 5',
    subject: 'Science',
    topic: 'Plants',
    ...
    hint: 'This part grows below the ground.',
    estimatedTimeSeconds: 40,
    marks: 2,
    isActive: true,
    statusId: 62,
  ...
  LocalQuestionRow(
    id: 'q-019',
    questionText: 'Fill in the blank: A noun names a person, place, or ____.',
    questionTypeId: 43,
    className: 'Grade 5',
    subject: 'English',
    topic: 'Grammar Revision',
  ...
  LocalQuestionRow(
    id: 'q-020',
    questionText: 'What is 0.7 written as a fraction in tenths?',
    questionTypeId: 40,
    className: 'Grade 5',
    subject: 'Mathematics',
    topic: 'Decimals',
  ...
  LocalQuestionRow(
    id: 'q-021',
    questionText: 'Select all examples of safe online behavior.',
    questionTypeId: 41,
    className: 'Grade 5',
    subject: 'Computer',
    topic: 'Online Safety',
    difficultyLevel: 'Medium',
    explanation:
        'Safe behavior includes keeping passwords private and asking an adult before sharing information.',
    hint: 'Choose actions that protect personal information.',
    estimatedTimeSeconds: 70,
    marks: 3,
    isActive: true,
    statusId: 62,
  ...
  LocalQuestionRow(
    id: 'q-022',
    questionText: 'Explain one way to stay safe in a science lab.',
    questionTypeId: 44,
    className: 'Grade 5',
    subject: 'Science',
    topic: 'Lab Safety',
    difficultyLevel: 'Medium',
    explanation:
        'A complete answer should mention a clear safety rule and why it matters.',
    hint: 'Think about goggles, instructions, or careful handling.',
    estimatedTimeSeconds: 120,
    marks: 4,
    isActive: true,
    statusId: 62,
  ...
  LocalQuestionRow(
    id: 'q-023',
    questionText: 'Which sentence uses future tense?',
    questionTypeId: 40,
    className: 'Grade 5',
    subject: 'English',
    topic: 'Speaking Practice',
    difficultyLevel: 'Medium',
    explanation: 'The word will often shows future tense.',
    hint: 'Look for an action that has not happened yet.',
    estimatedTimeSeconds: 45,
    marks: 2,
    isActive: true,
    statusId: 62,
  ...
  LocalQuestionRow(
    id: 'q-025',
    questionText: 'Name one producer in a food chain.',
    questionTypeId: 44,
    className: 'Grade 5',
    subject: 'Science',
    topic: 'Food Chains',
    difficultyLevel: 'Medium',
    explanation: 'Plants are producers because they make their own food.',
    hint: 'Think about organisms that make food using sunlight.',
...
final localQuestionOptionRows = <LocalQuestionOptionRow>[
  ...
  const LocalQuestionOptionRow(
    ...
    optionImageUrl: '',
    isCorrect: false,
    explanation: '1/3 is not equivalent to 3/6.',
    isActive: true,
  ),
  const LocalQuestionOptionRow(
    id: 'qo-016-c',
    ...
    optionImageUrl: '',
    isCorrect: false,
    explanation: '2/3 is greater than 3/6.',
    isActive: true,
  ),
  const LocalQuestionOptionRow(
    id: 'qo-017-a',
    ...
    optionImageUrl: '',
    isCorrect: true,
    explanation: 'A keyboard is an input device for typing.',
    isActive: true,
  ),
  const LocalQuestionOptionRow(
    id: 'qo-017-b',
  ...
  const LocalQuestionOptionRow(
    ...
    optionImageUrl: '',
    isCorrect: false,
    explanation: 'Flowers help plants reproduce.',
    isActive: true,
  ),
  const LocalQuestionOptionRow(
    id: 'qo-018-c',
    ...
    optionImageUrl: '',
    isCorrect: false,
    explanation: 'Leaves mainly make food through photosynthesis.',
    isActive: true,
  ),
  const LocalQuestionOptionRow(
    id: 'qo-020-a',
  ...
  const LocalQuestionOptionRow(
    ...
    optionImageUrl: '',
    isCorrect: false,
    explanation: '70/1 equals 70.',
    isActive: true,
  ),
  const LocalQuestionOptionRow(
    id: 'qo-021-a',
    questionId: 'q-021',
    optionText: 'Keep your password private',
    optionImageUrl: '',
    isCorrect: true,
    explanation: 'Passwords should not be shared.',
    isActive: true,
  ),
  const LocalQuestionOptionRow(
    id: 'qo-021-b',
    questionId: 'q-021',
    optionText: 'Ask an adult before sharing information',
    optionImageUrl: '',
    isCorrect: true,
    explanation: 'An adult can help decide what is safe.',
    isActive: true,
  ),
  const LocalQuestionOptionRow(
    id: 'qo-021-c',
    questionId: 'q-021',
    optionText: 'Share your address with strangers',
    optionImageUrl: '',
    isCorrect: false,
    explanation: 'Personal address should not be shared with strangers.',
    isActive: true,
  ),
  const LocalQuestionOptionRow(
    id: 'qo-023-a',
    questionId: 'q-023',
    optionText: 'I will read tomorrow.',
    optionImageUrl: '',
    isCorrect: true,
    explanation: 'Will read describes a future action.',
    isActive: true,
  ),
  const LocalQuestionOptionRow(
    id: 'qo-023-b',
    questionId: 'q-023',
    optionText: 'I read yesterday.',
    optionImageUrl: '',
    isCorrect: false,
  ...
  const LocalQuestionOptionRow(
    id: 'qo-023-c',
    questionId: 'q-023',
    optionText: 'I am reading now.',
    optionImageUrl: '',
    isCorrect: false,
    explanation: 'Now shows present continuous tense.',
    isActive: true,
  ),
  const LocalQuestionOptionRow(
    id: 'qo-024-a',
...
QuizSummary _toQuizSummary(LocalQuizRow row) {
  return QuizSummary(
    ...
    completedAt: _completedAt(row.id),
...
DateTime? _completedAt(String quizId) {
  for (final attempt in localQuizAttemptRows) {
    if (attempt.quizId == quizId && attempt.submittedAt != null) {
